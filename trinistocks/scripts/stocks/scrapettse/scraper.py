    ...
    try:
        ...
        for symbol in listed_stock_symbols:
            try:
                ...
                logger.debug("Successfully added basic listing data for: " +
...
def scrape_equity_summary_data(dates_to_fetch,):
    """
    ...
    try:
        ...
        for symbol in all_symbols:
            try:
                ...
                logger.debug("Navigating to "+stock_summary_page +
