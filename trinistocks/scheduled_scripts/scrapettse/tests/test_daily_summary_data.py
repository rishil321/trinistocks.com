...
from scheduled_scripts.scrapettse.daily_summary_data import DailySummaryDataScraper
...
def test_update_update_equity_summary_data():
    ...
    dates_to_fetch_sublists = daily_summary_data_scraper.update_equity_summary_data(start_date=start_date)
