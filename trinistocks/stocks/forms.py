...
class RegisterForm(forms.Form):
    ...
    def clean_email(self):
        ...
        try:
            ...
            # if an exception is not raised, then this user already exists
            raise ValidationError(
                "This email address has already been used. Please choose another or reset the password for this user."
            )
        except models.User.DoesNotExist:
            # continue since this user does not already exist.
            pass
...
class PortfolioTransactionForm(forms.Form):
    ...
    def clean_num_shares(self):
        ...
        try:
            ...
            raise ValidationError(
                "You have not entered a valid number of shares. Please recheck."
            )
        return num_shares
